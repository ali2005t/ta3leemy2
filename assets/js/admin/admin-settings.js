...
document.addEventListener('DOMContentLoaded', () => {
    ...
    window.selectLayout = function (layout, el) {
        ...
        if (el) {
            ...
            el.style.borderColor = '#3b82f6'; // hardcode blue or var
        }
    };
        ...
        try {
            ...
            if (docSnap.exists()) {
                ...
                if (data.landingLayout) {
                    const el = document.querySelector(`.layout-option[data-layout="${data.landingLayout}"]`);
                    if (el) window.selectLayout(data.landingLayout, el);
                }
            }
        } catch (e) {
    ...
    form.addEventListener('submit', async (e) => {
        ...
        try {
            const data = {
                ...
                landingLayout: (() => {
                    const active = document.querySelector('.layout-option.active');
                    return active ? active.getAttribute('data-layout') : 'v1';
                })(),
