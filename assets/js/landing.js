        ...
        if (pricingSnap.exists()) {
            ...
            packagesData = {
                basic: {
                    ...
                    priceMonthly: "199",
                    priceYearly: "1990",
                    tagline: "بداية قوية للمدرسين",
                    btnText: "اشترك الآن",
                    features: "منصة ويب خاصة\n50 طالب نشط\nحماية للمحتوى\nدعم فني عبر الواتساب"
                },
                pro: {
                    title: "باقة المحترفين",
                    priceMonthly: "499",
                    priceYearly: "4990",
                    tagline: "للأكاديميات والنمو السريع",
                    isPopular: true,
                    btnText: "الأكثر طلباً",
                    features: "كل مميزات الأساسية\nتطبيق أندرويد خاص\n500 طالب نشط\nتقارير متقدمة\nاستضافة فيديو خاصة"
                },
                elite: {
                    title: "الباقة الشاملة",
                    priceMonthly: "999",
                    priceYearly: "9990",
                    tagline: "سيطرة كاملة وتوسع لا محدود",
                    btnText: "تواصل معنا",
                    features: "كل مميزات المحترفين\nتطبيق iOS (آيفون)\nعدد لا محدود من الطلاب\nسيرفر خاص VDS\nمدير حساب شخصي"
                }
            };
        }
        renderPricingCards();
