...
document.addEventListener('DOMContentLoaded', () => {
    ...
    window.selectLayout = function (layout, el) {
        document.querySelectorAll('.layout-option').forEach(i => {
    ...
    window.saveAppSettings = async function () {
        ...
        // Get Layout
        const activeLayoutEl = document.querySelector('.layout-option.active');
        const layout = activeLayoutEl ? activeLayoutEl.getAttribute('data-layout') : 'v1';
        ...
        try {
            ...
            await updateDoc(doc(db, "teachers", targetUid), {
                ...
                "appSettings.landingLayout": layout,
            ...
            try {
                ...
                if (docSnap.exists()) {
                    ...
                    if (data.appSettings) {
                        ...
                        if (settings.landingLayout) {
                            const el = document.querySelector(`.layout-option[data-layout="${settings.landingLayout}"]`);
                            if (el) window.selectLayout(settings.landingLayout, el);
                        }
                    }
